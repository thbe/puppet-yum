...
class yum::params {
  ...
  if $::operatingsystemmajrelease == '6' {
    ...
    $el_foreman_source               = 'baseurl=http://yum.theforeman.org/releases/1.8/el6/source/'
    $el_foreman_plugins              = 'baseurl=http://yum.theforeman.org/plugins/1.8/el6/$basearch/'
    $el_foreman_plugins_source       = 'baseurl=http://yum.theforeman.org/plugins/1.8/el6/source/'
  ...
  if $::operatingsystemmajrelease == '7' {
    ...
    $el_foreman                      = 'baseurl=http://yum.theforeman.org/releases/1.8/el7/$basearch/'
    $el_foreman_source               = 'baseurl=http://yum.theforeman.org/releases/1.8/el7/source/'
    $el_foreman_plugins              = 'baseurl=http://yum.theforeman.org/plugins/1.8/el7/$basearch/'
    $el_foreman_plugins_source       = 'baseurl=http://yum.theforeman.org/plugins/1.8/el7/source/'
