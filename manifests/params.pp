...
class yum::params {
  ...
  $el6Slx                         = 'mirrorlist=http://ftp.scientificlinux.org/linux/scientific/mirrorlist/sl-base-6x.txt'
  $el6SlxSecurity                 = 'mirrorlist=http://ftp.scientificlinux.org/linux/scientific/mirrorlist/sl-security-6x.txt'
  $el6SlxFastbugs                 = 'mirrorlist=http://ftp.scientificlinux.org/linux/scientific/mirrorlist/sl-fastbugs-6x.txt'
  ...
  $el6SlxFile                 = '/etc/yum.repos.d/sl6x.repo'
  ...
  $el6SlxTemplate                 = 'yum/etc/yum.repos.d/el6/sl6x.repo.erb'
